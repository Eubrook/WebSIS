...
def update_students():
    ...
    if update_form.validate_on_submit():
        ...
        if file and file.filename != '':
            ...
            prof_pic = models.get_student_prof_pic(original_id)
    ...
    return render_template('students/students.html', students=students, form=add_form, update_form=update_form, course_codes=course_codes)
